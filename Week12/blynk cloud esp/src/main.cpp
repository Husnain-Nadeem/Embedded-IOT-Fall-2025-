...
#define BLYNK_TEMPLATE_ID "TMPL6kxz_0rD"
#define BLYNK_TEMPLATE_NAME "DHT by Nasir"
#define BLYNK_AUTH_TOKEN    "KaEX0Y7JLI52fq9_kK2L-TdcOjMJi5"  // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
